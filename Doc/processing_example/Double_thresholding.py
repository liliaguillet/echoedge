...
dest_path_max = "Output/DOUBLE THRESHOLDING/Thresh_max"    # Path to save the thresh_max curve
dest_path_min = "Output/DOUBLE THRESHOLDING/Thresh_min"    # Path to save the thresh_min curve
csv_path = "Output/PREPROCESS_DATA/Csv"                   #  Path where the original .csv files are stored
dest_path_dt = "Output/DOUBLE THRESHOLDING/Schools"   # path to save the double threshold output images
