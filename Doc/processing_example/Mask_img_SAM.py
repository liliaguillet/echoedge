...
# PATH #################################################################################
path_npy = "Output/PREPROCESS_DATA/Resize"# Resize image
dest_path_png = "Output/PREPROCESS_DATA/Mask" # Where the masked image will be saved
csv_path = "Output/PREPROCESS_DATA/Csv" #Csv file from the first output
######################################################################################
