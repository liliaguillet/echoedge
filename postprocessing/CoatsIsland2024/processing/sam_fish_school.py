...
##############################################################################################
dest_path = "F:/DATA_HUDSON/PROCESS/Segment_Anything"    # path to save the choosed informations from the sam segmentations
npy_path = 'F:/DATA_HUDSON/PROCESS/Resize'# Resize image                      #  Path where the resized .npy files are stored
csv_path = 'F:/DATA_HUDSON/PROCESS/csv' #Csv file from the first output
img_path = "F:/DATA_HUDSON/PROCESS/Mask"        #  Path where the resized and corrected images are stored
...
sam_result_path = "F:/DATA_HUDSON/PROCESS/Segment_Anything/output_hudson/output_hudson/sam_results.pkl"    #  Path where the segmentations by sam is stored
