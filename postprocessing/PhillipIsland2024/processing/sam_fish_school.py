...
##############################################################################################
dest_path = "F:/SURVEY2025/SEGMENT_ANYTHING"    # path to save the choosed informations from the sam segmentations
...
img_path = "F:/SURVEY2025/PREPROCESS_DATA/Mask"        #  Path where the resized and corrected images are stored
...
sam_result_path = "F:/SURVEY2025/SEGMENT_ANYTHING/sam_results.pkl"    #  Path where the segmentations by sam is stored
