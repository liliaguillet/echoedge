...
##############################################################################################
dest_path = "F:/Results_Baltic/Segment_Anything"    # path to save the choosed informations from the sam segmentations
npy_path = "F:/Results_Baltic/Resize"# Resize image                      #  Path where the resized .npy files are stored
csv_path = 'F:/Results_Baltic/csv' #Csv file from the first output
img_path = "F:/Results_Baltic/Mask"        #  Path where the resized and corrected images are stored
...
sam_result_path = "F:/Results_Baltic/Segment_Anything/output_baltic/output_baltic/sam_results.pkl"    #  Path where the segmentations by sam is stored
