...
###################################               path part                   ###################################  
npy_path = "F:/Results_Baltic/Resize"               #  Path where the resized .npy files are stored
dest_path_max = "F:/Results_Baltic/Thresh_max"    # Path to save the thresh_max curve
dest_path_min = "F:/Results_Baltic/Thresh_min"    # Path to save the thresh_min curve
csv_path = "F:/Results_Baltic/csv"                #  Path where the original .csv files are stored
dest_path_dt =  "F:/Results_Baltic/Schools"   # path to save the double threshold output images
